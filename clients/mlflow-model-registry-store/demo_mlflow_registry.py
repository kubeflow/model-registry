...
def setup_tracking():
    ...
    if registry_uri:
        print(f"Using Model Registry backend: {registry_uri}")
        mlflow.set_registry_uri(registry_uri)
    else:
        print(f"Using native MLflow backend: {tracking_uri}")
...
def demo_model_management():
    """Demo: Comprehensive model management operations."""
...
def demo_tags_and_metadata():
    ...
    client.update_registered_model(
        model_name,
        description="Updated: Regression model with multiple versions and comprehensive tagging"
    )
...
def run_comprehensive_demo():
    ...
    print("=" * 80)
    print("MLflow Model Registry Comprehensive Demo")
    print("=" * 80)
