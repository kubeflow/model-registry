...
func (app *App) Routes() http.Handler {
	...
	// (Kubeflow integration mode is when both FederatedPlatform and StandaloneMode are false)
	isKubeflowIntegrationMode := !app.config.FederatedPlatform && !app.config.StandaloneMode
