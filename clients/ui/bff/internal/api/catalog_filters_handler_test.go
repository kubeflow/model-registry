...
var _ = Describe("TestGetCatalogFilterListHandler", func() {
	Context("testing catalog filter list handler", Ordered, func() {
		...
		// 	actual, rs, err := setupApiTest[CatalogFilterOptionEnvelope](http.MethodGet, "/api/v1/model_catalog/models/filter_options?namespace=kubeflow", nil, kubernetesMockedStaticClientFactory, requestIdentify, "kubeflow")
