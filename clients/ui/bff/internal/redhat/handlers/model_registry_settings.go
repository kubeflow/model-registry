...
// Since this package is only imported for downstream builds, the override is always active.
// Keeping this function allows future gating if needed (e.g., feature flags).
