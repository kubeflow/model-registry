...
func main() {
	...
	// TODO: refactor these platform flags to use enum values rather than booleans
	flag.BoolVar(&cfg.FederatedPlatform, "federated-platform", false, "Use default platform for non-kubeflow deployments")
