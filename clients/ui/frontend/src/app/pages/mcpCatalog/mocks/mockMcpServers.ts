...
const dynatraceTools: McpTool[] = [
  ...
  },
  {
    ...
    parameters: [
      ...
      },
      {
        name: 'status',
        type: 'string',
        description: 'Filter by vulnerability status (open, resolved, suppressed)',
        required: false,
      },
    ],
  },
  {
    ...
    parameters: [
      { name: 'query', type: 'string', description: 'PromQL query expression', required: true },
      {
        name: 'time',
        type: 'string',
        description: 'Evaluation timestamp (ISO format)',
        required: false,
      },
      {
        name: 'timeout',
        type: 'string',
        description: 'Evaluation timeout duration',
        required: false,
      },
    ],
  },
  ...
  },
  {
    ...
    accessType: 'read_only',
    parameters: [{ name: 'metric', type: 'string', description: 'Metric name', required: true }],
  },
  {
    name: 'list_targets',
  ...
  },
  {
    ...
    parameters: [
      ...
      { name: 'replicas', type: 'integer', description: 'Number of replicas', required: false },
      {
        name: 'image',
        type: 'string',
        description: 'Container image URI for the model server',
        required: true,
      },
    ],
  },
