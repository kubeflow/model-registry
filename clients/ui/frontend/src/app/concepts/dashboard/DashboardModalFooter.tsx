    ...
    <DialogActions>
      <Stack spacing={2}>
        {error && (
          <Alert
            severity="error"
            action={<IconButton size="small" aria-label="close" color="inherit" onClick={onReset}><Close fontSize="small" /></IconButton>}
          >
        ...
        <Stack direction="row" spacing={1}>
          ...
          {!hideCancel && <Button variant="outlined" onClick={onCancel}>{cancelLabel}</Button>}
        </Stack>
        {children}
      </Stack>
    </DialogActions>
