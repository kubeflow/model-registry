...
export const mockCatalogModel = (partial?: Partial<CatalogModel>): CatalogModel => ({
  ...
  readme: `---
    ...
    - granite-3.1
    base_model:
    - sample-source-granite/granite-3.1-8b-base
    ---
...
export const mockCatalogModelList = (partial?: Partial<CatalogModelList>): CatalogModelList => ({
...
export const MOCK_VARIANT_GROUP_ID = 'test-variant-group-abc123';

export const mockVariantModel = (name: string, tensorType: string): CatalogModel =>
  mockCatalogModel({
    name,
    source_id: 'sample-source',
    logo: 'data:image/svg+xml;base64,',
    customProperties: {
      ...
      tensor_type: {
        metadataType: ModelRegistryMetadataType.STRING,
        string_value: tensorType,
      },
    },
  });

export const mockVariantModels = [
  mockVariantModel('repo1/granite-8b-instruct', 'FP16'),
  mockVariantModel('repo1/granite-8b-int4', 'INT4'),
  mockVariantModel('repo1/granite-8b-int8', 'INT8'),
  mockVariantModel('repo1/granite-8b-bf16', 'BF16'),
];

export const mockModelNoVariantGroup = mockCatalogModel({
  name: 'repo1/model-without-variants',
  source_id: 'sample-source',
  customProperties: {},
});

export const mockVariantModelNoLogo = mockCatalogModel({
  name: 'repo1/granite-no-logo',
  source_id: 'sample-source',
  logo: undefined,
  customProperties: {
    validated: {
