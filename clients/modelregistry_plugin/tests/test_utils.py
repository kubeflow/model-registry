...
from modelregistry_plugin.utils import parse_tracking_uri, convert_timestamp, convert_modelregistry_state
...
class TestUtils:
    ...
    def test_parse_tracking_uri_https(self):
        ...
        host, port, secure = parse_tracking_uri("modelregistry+https://example.com:9000")
