"""New streamlined Model Registry store implementation."""
...
class ModelRegistryStore:
    """Streamlined Model Registry store implementation."""
    ...
    def get_metric_history(
        ...
        """
        return self.metrics.get_metric_history(run_id, metric_key, max_results)
