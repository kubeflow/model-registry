...
class RegisteredModel(BaseModel):
    ...
    name: StrictStr = Field(description="The client provided name of the model. It must be unique among all the RegisteredModels of the same type within a Model Registry instance and cannot be changed once set.")
