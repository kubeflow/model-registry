...
class ModelVersionCreate(BaseModel):
    ...
    name: StrictStr = Field(description="The client provided name of the model's version. It must be unique among all the ModelVersions of the same type within a Model Registry instance and cannot be changed once set.")
