...
class Experiment(BaseModel):
    ...
    name: StrictStr = Field(description="The client provided name of the experiment. It must be unique among all the Experiments of the same type within a Model Registry instance and cannot be changed once set.")
