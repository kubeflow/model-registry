...
class Experiment(BaseModel):
    """
    An experiment in model registry. An experiment has ExperimentRun children.
    """ # noqa: E501
    ...
    name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="The client provided name of the experiment. It must be unique among all the Experiments of the same type within a Model Registry instance and cannot be changed once set.")
    ...
    state: Optional[ExperimentState] = ExperimentState.LIVE
    __properties: ClassVar[List[str]] = ["customProperties", "description", "externalId", "name", "id", "createTimeSinceEpoch", "lastUpdateTimeSinceEpoch", "owner", "state"]
