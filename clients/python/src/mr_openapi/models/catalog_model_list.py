...
class CatalogModelList(BaseModel):
    """List of CatalogModel entities."""  # noqa: E501
    ...
    items: list[CatalogModel] = Field(description="Array of `CatalogModel` entities.")
    ...
    def from_json(cls, json_str: str) -> Self | None:
        """Create an instance of CatalogModelList from a JSON string."""
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        """Create an instance of CatalogModelList from a dict."""
        if obj is None:
            return None
        ...
        return cls.model_validate(
            {
                ...
                "size": obj.get("size"),
                "items": (
                    [CatalogModel.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
                ),
            }
        )
