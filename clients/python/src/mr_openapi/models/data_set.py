...
class DataSet(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["customProperties", "description", "externalId", "name", "id", "createTimeSinceEpoch", "lastUpdateTimeSinceEpoch", "experimentId", "experimentRunId", "artifactType", "digest", "sourceType", "source", "schema", "profile", "uri", "state"]
