...
class CatalogSourceList(BaseModel):
    """List of CatalogSource entities."""  # noqa: E501
    ...
    items: list[CatalogSource] | None = Field(default=None, description="Array of `CatalogSource` entities.")
        ...
        return cls.model_validate(
            {
                ...
                "size": obj.get("size"),
                "items": (
                    [CatalogSource.from_dict(_item) for _item in obj["items"]]
