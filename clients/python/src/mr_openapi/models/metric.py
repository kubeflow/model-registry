...
class Metric(BaseModel):
    ...
    experiment_id: Optional[StrictStr] = Field(default=None, description="Optional id of the experiment that produced this artifact.", alias="experimentId")
    experiment_run_id: Optional[StrictStr] = Field(default=None, description="Optional id of the experiment run that produced this artifact.", alias="experimentRunId")
