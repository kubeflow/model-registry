...
class Metric(BaseModel):
    ...
    experiment_id: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="Optional id of the experiment that produced this artifact.", alias="experimentId")
    experiment_run_id: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="Optional id of the experiment run that produced this artifact.", alias="experimentRunId")
    ...
    __properties: ClassVar[List[str]] = ["customProperties", "description", "externalId", "name", "id", "createTimeSinceEpoch", "lastUpdateTimeSinceEpoch", "experimentId", "experimentRunId", "artifactType", "value", "timestamp", "step", "state"]
