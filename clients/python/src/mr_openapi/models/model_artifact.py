...
class ModelArtifact(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["customProperties", "description", "externalId", "uri", "state", "name", "id", "createTimeSinceEpoch", "lastUpdateTimeSinceEpoch", "artifactType", "modelFormatName", "storageKey", "storagePath", "modelFormatVersion", "serviceAccountName", "modelSourceKind", "modelSourceClass", "modelSourceGroup", "modelSourceId", "modelSourceName"]
