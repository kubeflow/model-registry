...
class ModelArtifact(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["customProperties", "description", "externalId", "name", "id", "createTimeSinceEpoch", "lastUpdateTimeSinceEpoch", "experimentId", "experimentRunId", "artifactType", "modelFormatName", "storageKey", "storagePath", "modelFormatVersion", "serviceAccountName", "modelSourceKind", "modelSourceClass", "modelSourceGroup", "modelSourceId", "modelSourceName", "uri", "state"]
