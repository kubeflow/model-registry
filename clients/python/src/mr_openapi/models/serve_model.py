...
class ServeModel(BaseModel):
    ...
    """ # noqa: E501
    last_known_state: Optional[ExecutionState] = Field(default=None, alias="lastKnownState")
    ...
    model_version_id: StrictStr = Field(description="ID of the `ModelVersion` that was served in `InferenceService`.", alias="modelVersionId")
    __properties: ClassVar[List[str]] = ["lastKnownState", "customProperties", "description", "externalId", "name", "id", "createTimeSinceEpoch", "lastUpdateTimeSinceEpoch", "modelVersionId"]
