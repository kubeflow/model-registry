...
class InferenceService(BaseModel):
    ...
    model_version_id: Optional[StrictStr] = Field(default=None, description="ID of the `ModelVersion` to serve. If it's unspecified, then the latest `ModelVersion` by creation order will be served.", alias="modelVersionId")
    runtime: Optional[StrictStr] = Field(default=None, description="Model runtime.")
    desired_state: Optional[InferenceServiceState] = Field(default=None, alias="desiredState")
    registered_model_id: StrictStr = Field(description="ID of the `RegisteredModel` to serve.", alias="registeredModelId")
    serving_environment_id: StrictStr = Field(description="ID of the parent `ServingEnvironment` for this `InferenceService` entity.", alias="servingEnvironmentId")
