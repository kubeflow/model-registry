...
class ExperimentRunUpdate(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["customProperties", "description", "externalId", "endTimeSinceEpoch", "status", "state", "owner"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ExperimentRunUpdate from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ExperimentRunUpdate from a dict"""
        if obj is None:
            return None
