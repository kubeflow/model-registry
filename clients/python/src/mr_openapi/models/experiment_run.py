...
class ExperimentRun(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["customProperties", "description", "externalId", "name", "endTimeSinceEpoch", "status", "state", "owner", "experimentId", "startTimeSinceEpoch", "id", "createTimeSinceEpoch", "lastUpdateTimeSinceEpoch"]
