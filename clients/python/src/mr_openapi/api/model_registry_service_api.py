...
class ModelRegistryServiceApi:
    ...
    async def create_model_version_artifact(
        ...
        artifact: Annotated[
            Artifact, Field(description="A new `Artifact` to be created and associated with the `ModelVersion`.")
        ],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param artifact: A new `Artifact` to be created and associated with the `ModelVersion`. (required)
        :type artifact: Artifact
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    async def update_model_version_artifact(
        self,
        modelversion_id: Annotated[StrictStr, Field(description="A unique identifier for a `ModelVersion`.")],
        artifact_id: Annotated[StrictStr, Field(description="A unique identifier for an `Artifact`.")],
        artifact_update: Annotated[
            ArtifactUpdate, Field(description="Update an `ArtifactUpdate` in the `ModelVersion`.")
        ],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        """Update an Artifact in a ModelVersion.

        Updates an existing Artifact in the `ModelVersion`.

        :param modelversion_id: A unique identifier for a `ModelVersion`. (required)
        :type modelversion_id: str
        :param artifact_id: A unique identifier for an `Artifact`. (required)
        :type artifact_id: str
        :param artifact_update: Update an `ArtifactUpdate` in the `ModelVersion`. (required)
        :type artifact_update: ArtifactUpdate
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        :return: Returns the result object.
        """  # noqa: E501
        _param = self._update_model_version_artifact_serialize(
            modelversion_id=modelversion_id,
    ...
    @validate_call
    async def update_model_version_artifact_with_http_info(
        self,
        modelversion_id: Annotated[StrictStr, Field(description="A unique identifier for a `ModelVersion`.")],
        artifact_id: Annotated[StrictStr, Field(description="A unique identifier for an `Artifact`.")],
        artifact_update: Annotated[
    ...
    @validate_call
    async def update_model_version_artifact_without_preload_content(
        self,
        modelversion_id: Annotated[StrictStr, Field(description="A unique identifier for a `ModelVersion`.")],
        artifact_id: Annotated[StrictStr, Field(description="A unique identifier for an `Artifact`.")],
        artifact_update: Annotated[
    ...
    def _update_model_version_artifact_serialize(
        self,
        modelversion_id,
        artifact_id,
        artifact_update,
        ...
        return self.api_client.param_serialize(
            method="PATCH",
            resource_path="/api/model_registry/v1alpha3/model_versions/{modelversionId}/artifacts/{artifactId}",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
