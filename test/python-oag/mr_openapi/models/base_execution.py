...
class BaseExecution(BaseModel):
    ...
    __properties = ["lastKnownState", "customProperties", "description", "externalId", "name", "id", "createTimeSinceEpoch", "lastUpdateTimeSinceEpoch"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BaseExecution:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BaseExecution:
        """Create an instance of BaseExecution from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BaseExecution.parse_obj(obj)

        _obj = BaseExecution.parse_obj({
