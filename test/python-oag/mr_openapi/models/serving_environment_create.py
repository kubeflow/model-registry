...
class ServingEnvironmentCreate(BaseModel):
    ...
    __properties = ["customProperties", "description", "externalId", "name"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServingEnvironmentCreate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServingEnvironmentCreate:
        """Create an instance of ServingEnvironmentCreate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServingEnvironmentCreate.parse_obj(obj)

        _obj = ServingEnvironmentCreate.parse_obj({
