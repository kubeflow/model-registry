...
class ArtifactList(BaseModel):
    ...
    items: Optional[conlist(Artifact)] = Field(None, description="Array of `Artifact` entities.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ArtifactList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ArtifactList:
        """Create an instance of ArtifactList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ArtifactList.parse_obj(obj)

        _obj = ArtifactList.parse_obj({
            "next_page_token": obj.get("nextPageToken"),
            "page_size": obj.get("pageSize"),
            "size": obj.get("size"),
            "items": [Artifact.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
