...
class ServeModelUpdate(BaseModel):
    ...
    __properties = ["lastKnownState", "customProperties", "description", "externalId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServeModelUpdate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServeModelUpdate:
        """Create an instance of ServeModelUpdate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServeModelUpdate.parse_obj(obj)

        _obj = ServeModelUpdate.parse_obj({
