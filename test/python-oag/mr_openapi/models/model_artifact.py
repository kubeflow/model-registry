...
class ModelArtifact(BaseModel):
    ...
    __properties = ["customProperties", "description", "externalId", "uri", "state", "name", "id", "createTimeSinceEpoch", "lastUpdateTimeSinceEpoch", "modelFormatName", "storageKey", "storagePath", "modelFormatVersion", "serviceAccountName"]
    ...
    def from_dict(cls, obj: dict) -> ModelArtifact:
        ...
        if not isinstance(obj, dict):
            return ModelArtifact.parse_obj(obj)

        if not obj.get("artifactType") == "model-artifact": # MM
            return None # MM
        _obj = ModelArtifact.parse_obj({
            "artifact_type": "model-artifact", # MM
