...
class ModelVersionCreate(BaseModel):
    ...
    __properties = ["customProperties", "description", "externalId", "name", "state", "author", "registeredModelId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ModelVersionCreate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ModelVersionCreate:
        """Create an instance of ModelVersionCreate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ModelVersionCreate.parse_obj(obj)

        _obj = ModelVersionCreate.parse_obj({
