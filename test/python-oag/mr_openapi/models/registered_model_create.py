...
class RegisteredModelCreate(BaseModel):
    ...
    __properties = ["customProperties", "description", "externalId", "name", "owner", "state"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RegisteredModelCreate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RegisteredModelCreate:
        """Create an instance of RegisteredModelCreate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RegisteredModelCreate.parse_obj(obj)

        _obj = RegisteredModelCreate.parse_obj({
