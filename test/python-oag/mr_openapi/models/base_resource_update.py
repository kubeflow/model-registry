...
class BaseResourceUpdate(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BaseResourceUpdate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BaseResourceUpdate:
        """Create an instance of BaseResourceUpdate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BaseResourceUpdate.parse_obj(obj)

        _obj = BaseResourceUpdate.parse_obj({
