...
class RegisteredModelList(BaseModel):
    ...
    items: Optional[conlist(RegisteredModel)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RegisteredModelList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RegisteredModelList:
        """Create an instance of RegisteredModelList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RegisteredModelList.parse_obj(obj)

        _obj = RegisteredModelList.parse_obj({
            "next_page_token": obj.get("nextPageToken"),
            "page_size": obj.get("pageSize"),
            "size": obj.get("size"),
            "items": [RegisteredModel.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
