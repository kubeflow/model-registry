...
class ServingEnvironmentUpdate(BaseModel):
    ...
    __properties = ["customProperties", "description", "externalId"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServingEnvironmentUpdate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServingEnvironmentUpdate:
        """Create an instance of ServingEnvironmentUpdate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServingEnvironmentUpdate.parse_obj(obj)

        _obj = ServingEnvironmentUpdate.parse_obj({
