...
class BaseResourceCreate(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BaseResourceCreate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BaseResourceCreate:
        """Create an instance of BaseResourceCreate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BaseResourceCreate.parse_obj(obj)

        _obj = BaseResourceCreate.parse_obj({
