...
class ModelArtifactList(BaseModel):
    ...
    items: Optional[conlist(ModelArtifact)] = Field(None, description="Array of `ModelArtifact` entities.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ModelArtifactList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ModelArtifactList:
        """Create an instance of ModelArtifactList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ModelArtifactList.parse_obj(obj)

        _obj = ModelArtifactList.parse_obj({
            "next_page_token": obj.get("nextPageToken"),
            "page_size": obj.get("pageSize"),
            "size": obj.get("size"),
            "items": [ModelArtifact.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
