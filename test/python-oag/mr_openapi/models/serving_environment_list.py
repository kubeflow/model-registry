...
class ServingEnvironmentList(BaseModel):
    ...
    items: Optional[conlist(ServingEnvironment)] = None
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServingEnvironmentList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServingEnvironmentList:
        """Create an instance of ServingEnvironmentList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServingEnvironmentList.parse_obj(obj)

        _obj = ServingEnvironmentList.parse_obj({
            "next_page_token": obj.get("nextPageToken"),
            "page_size": obj.get("pageSize"),
            "size": obj.get("size"),
            "items": [ServingEnvironment.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
