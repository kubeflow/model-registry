...
class ModelVersion(BaseModel):
    ...
    author: Optional[StrictStr] = Field(None, description="Name of the author.")
    registered_model_id: StrictStr = Field(..., alias="registeredModelId", description="ID of the `RegisteredModel` to which this version belongs.")
    ...
    __properties = ["customProperties", "description", "externalId", "name", "state", "author", "registeredModelId", "id", "createTimeSinceEpoch", "lastUpdateTimeSinceEpoch"]
