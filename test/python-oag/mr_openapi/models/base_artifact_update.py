...
class BaseArtifactUpdate(BaseModel):
    """
    BaseArtifactUpdate
    """
    ...
    __properties = ["customProperties", "description", "externalId", "uri", "state"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BaseArtifactUpdate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BaseArtifactUpdate:
        """Create an instance of BaseArtifactUpdate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BaseArtifactUpdate.parse_obj(obj)

        _obj = BaseArtifactUpdate.parse_obj({
