...
class ServeModelList(BaseModel):
    ...
    items: Optional[conlist(ServeModel)] = Field(None, description="Array of `ModelArtifact` entities.")
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServeModelList:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServeModelList:
        """Create an instance of ServeModelList from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServeModelList.parse_obj(obj)

        _obj = ServeModelList.parse_obj({
            "next_page_token": obj.get("nextPageToken"),
            "page_size": obj.get("pageSize"),
            "size": obj.get("size"),
            "items": [ServeModel.from_dict(_item) for _item in obj.get("items")] if obj.get("items") is not None else None
        })
        return _obj
