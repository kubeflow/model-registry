...
class DocArtifact(BaseModel):
    ...
    __properties = ["customProperties", "description", "externalId", "uri", "state", "name", "id", "createTimeSinceEpoch", "lastUpdateTimeSinceEpoch"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> DocArtifact:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> DocArtifact:
        """Create an instance of DocArtifact from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return DocArtifact.parse_obj(obj)

        if not obj.get("artifactType") == "doc-artifact": # MM
            return None # MM
        _obj = DocArtifact.parse_obj({
            "artifact_type": "doc-artifact", # MM
