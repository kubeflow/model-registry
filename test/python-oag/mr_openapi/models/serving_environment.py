...
class ServingEnvironment(BaseModel):
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ServingEnvironment:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ServingEnvironment:
        """Create an instance of ServingEnvironment from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ServingEnvironment.parse_obj(obj)

        _obj = ServingEnvironment.parse_obj({
