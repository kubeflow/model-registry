...
class BaseExecutionUpdate(BaseModel):
    ...
    __properties = ["customProperties", "description", "externalId", "lastKnownState"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BaseExecutionUpdate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BaseExecutionUpdate:
        """Create an instance of BaseExecutionUpdate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BaseExecutionUpdate.parse_obj(obj)

        _obj = BaseExecutionUpdate.parse_obj({
