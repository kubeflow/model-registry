...
class ModelArtifactCreate(BaseModel):
    ...
    __properties = ["customProperties", "description", "externalId", "uri", "state", "name", "modelFormatName", "storageKey", "storagePath", "modelFormatVersion", "serviceAccountName"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ModelArtifactCreate:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ModelArtifactCreate:
        """Create an instance of ModelArtifactCreate from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return ModelArtifactCreate.parse_obj(obj)

        _obj = ModelArtifactCreate.parse_obj({
