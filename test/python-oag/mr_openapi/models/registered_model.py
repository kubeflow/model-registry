...
class RegisteredModel(BaseModel):
    ...
    __properties = ["customProperties", "description", "externalId", "name", "id", "createTimeSinceEpoch", "lastUpdateTimeSinceEpoch", "owner", "state"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> RegisteredModel:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> RegisteredModel:
        """Create an instance of RegisteredModel from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return RegisteredModel.parse_obj(obj)

        _obj = RegisteredModel.parse_obj({
