...
$OPENAPI_GENERATOR generate \
    ...
    --ignore-file-override "$PROJECT_ROOT"/.openapi-generator-ignore --additional-properties=outputAsLibrary=true,enumClassPrefix=true,router=chi,sourceFolder=,isGoSubmodule=true,enumClassPrefix=true,useOneOfDiscriminatorLookup=true,featureCORS=true \
...
$PROJECT_ROOT/bin/goimports -w "$PROJECT_ROOT"/internal/server/openapi
