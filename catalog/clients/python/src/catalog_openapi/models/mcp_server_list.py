...
class MCPServerList(BaseModel):
    ...
    items: List[MCPServer] = Field(description="Array of `MCPServer` entities.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "size": obj.get("size"),
            "items": [MCPServer.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
