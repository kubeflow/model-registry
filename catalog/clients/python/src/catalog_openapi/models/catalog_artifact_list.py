...
class CatalogArtifactList(BaseModel):
    """List of CatalogModel entities.
    """ # noqa: E501
    ...
    items: list[CatalogArtifact] = Field(description="Array of `CatalogArtifact` entities.")
    ...
    def from_json(cls, json_str: str) -> Self | None:
        """Create an instance of CatalogArtifactList from a JSON string"""
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        """Create an instance of CatalogArtifactList from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "size": obj.get("size"),
            "items": [CatalogArtifact.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
