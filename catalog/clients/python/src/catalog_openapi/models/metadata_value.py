...
class MetadataValue(BaseModel):
    ...
    actual_instance: MetadataBoolValue | MetadataDoubleValue | MetadataIntValue | MetadataProtoValue | MetadataStringValue | MetadataStructValue | None = None
    ...
    def to_dict(self) -> dict[str, Any] | MetadataBoolValue | MetadataDoubleValue | MetadataIntValue | MetadataProtoValue | MetadataStringValue | MetadataStructValue | None:
