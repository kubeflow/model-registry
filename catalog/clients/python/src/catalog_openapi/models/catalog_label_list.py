...
class CatalogLabelList(BaseModel):
    """List of CatalogLabel entities.
    """ # noqa: E501
    ...
    items: list[CatalogLabel] = Field(description="Array of `CatalogLabel` entities.")
    ...
    def from_json(cls, json_str: str) -> Self | None:
        """Create an instance of CatalogLabelList from a JSON string"""
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        """Create an instance of CatalogLabelList from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "size": obj.get("size"),
            "items": [CatalogLabel.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
