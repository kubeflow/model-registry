...
class CatalogSourceList(BaseModel):
    """List of CatalogSource entities.
    """ # noqa: E501
    ...
    items: list[CatalogSource] = Field(description="Array of `CatalogSource` entities.")
    ...
    def from_dict(cls, obj: dict[str, Any] | None) -> Self | None:
        ...
        _obj = cls.model_validate({
            ...
            "size": obj.get("size"),
            "items": [CatalogSource.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
