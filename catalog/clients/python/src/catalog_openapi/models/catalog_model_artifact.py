...
class CatalogModelArtifact(BaseModel):
    ...
    name: Annotated[str, Field(min_length=1, strict=True)] | None = Field(default=None, description="The client provided name of the artifact. This field is optional. If set, it must be unique among all the artifacts of the same artifact type within a database instance and cannot be changed once set.")
