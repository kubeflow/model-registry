...
class MCPToolsList(BaseModel):
    ...
    items: List[MCPTool] = Field(description="Array of `MCPTool` entities.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MCPToolsList from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MCPToolsList from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "size": obj.get("size"),
            "items": [MCPTool.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None
        })
        return _obj
