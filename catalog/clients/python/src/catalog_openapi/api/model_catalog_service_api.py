...
class ModelCatalogServiceApi:
    ...
    def find_labels(
        self,
        asset_type: Annotated[CatalogAssetType | None, Field(description="Filter by asset type.")] = None,
    ...
    def find_models(
        self,
        target_rps: Annotated[StrictInt | None, Field(description="Target requests per second for latency calculations")] = None,
        latency_property: Annotated[StrictStr | None, Field(description="Property name for latency metric")] = None,
        rps_property: Annotated[StrictStr | None, Field(description="Property name for RPS metric")] = None,
        hardware_count_property: Annotated[StrictStr | None, Field(description="Property name for hardware count")] = None,
        hardware_type_property: Annotated[StrictStr | None, Field(description="Property name for hardware type grouping")] = None,
        ...
        page_size: Annotated[Annotated[str, Field(strict=True)] | None, Field(description="Number of entities in each page.")] = None,
        order_by: Annotated[OrderByField | None, Field(description="Specifies the order by criteria for listing entities.  Supported values are: - CREATE_TIME - LAST_UPDATE_TIME - ID - NAME - ACCURACY - RECOMMENDED  Defaults to `NAME`.  The `ACCURACY` sort will sort by the `overall_average` property in any linked metrics artifact.  The `RECOMMENDED` sort applies Pareto filtering and ranks models by recommended latency. The Pareto-related parameters (`targetRPS`, `latencyProperty`, `rpsProperty`, `hardwareCountProperty`, `hardwareTypeProperty`) tune the ranking. With the default `sortOrder=ASC`, the most recommended models (lowest latency) appear first. Use `sortOrder=DESC` to show the least recommended configurations first.  In addition, models can be sorted by properties. For example: - `provider.string_value` sorts by provider name - `artifacts.ifeval.double_value` sorts by the min/max value a property called ifeval across all associated artifacts")] = None,
        sort_order: Annotated[SortOrder | None, Field(description="Specifies the sort order for listing entities, defaults to ASC.")] = None,
        next_page_token: Annotated[StrictStr | None, Field(description="Opaque pagination token returned by a previous list call. Do not construct manually; use the value from a prior response's nextPageToken field.")] = None,
        _request_timeout: None | Annotated[StrictFloat, Field(gt=0)] | tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]] = None,
        _request_auth: dict[StrictStr, Any] | None = None,
    ...
    def _find_models_serialize(
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/api/model_catalog/v1/models",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _find_models_filter_options_serialize(
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/api/model_catalog/v1/models/filter_options",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def find_sources(
        self,
        name: Annotated[Annotated[str, Field(strict=True)] | None, Field(description="Name of entity to search.")] = None,
        asset_type: Annotated[CatalogAssetType | None, Field(description="Filter by asset type.")] = None,
        page_size: Annotated[Annotated[str, Field(strict=True)] | None, Field(description="Number of entities in each page.")] = None,
    ...
    def _get_all_model_artifacts_serialize(
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/api/model_catalog/v1/sources/{source_id}/models/{model_name}/artifacts",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_all_model_performance_artifacts_serialize(
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/api/model_catalog/v1/sources/{source_id}/models/{model_name}/artifacts/performance",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_model_serialize(
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/api/model_catalog/v1/sources/{source_id}/models/{model_name+}",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def preview_catalog_source(
        ...
        page_size: Annotated[Annotated[str, Field(strict=True)] | None, Field(description="Number of entities in each page.")] = None,
        next_page_token: Annotated[StrictStr | None, Field(description="Opaque pagination token returned by a previous list call. Do not construct manually; use the value from a prior response's nextPageToken field.")] = None,
        filter_status: Annotated[StrictStr | None, Field(description="Filter the response to show specific asset statuses: - `all` (default): Show all assets regardless of inclusion status - `included`: Show only assets that pass the configured filters - `excluded`: Show only assets that are filtered out")] = None,
    ...
    def _preview_catalog_source_serialize(
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/api/model_catalog/v1/sources/preview",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
