...
class AgentCatalogServiceApi:
    ...
    def _find_agents_serialize(
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/api/agent_catalog/v1/agents",
    ...
    def _find_agents_filter_options_serialize(
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/api/agent_catalog/v1/agents/filter_options",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_agent_serialize(
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/api/agent_catalog/v1/agents/{id}",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_agent_artifacts(
        ...
        artifact_type: Annotated[list[AgentArtifactTypeQueryParam] | None, Field(description="Filter artifacts by type.")] = None,
        page_size: Annotated[Annotated[str, Field(strict=True)] | None, Field(description="Number of entities in each page.")] = None,
        order_by: Annotated[OrderByField | None, Field(description="Specifies the order by criteria for listing entities.")] = None,
        sort_order: Annotated[SortOrder | None, Field(description="Specifies the sort order for listing entities, defaults to ASC.")] = None,
        next_page_token: Annotated[StrictStr | None, Field(description="Opaque pagination token returned by a previous list call. Do not construct manually; use the value from a prior response's nextPageToken field.")] = None,
    ...
    def _get_agent_artifacts_serialize(
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/api/agent_catalog/v1/agents/{id}/artifacts",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
