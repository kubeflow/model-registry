...
class MCPCatalogServiceApi:
    ...
    def _find_mcp_server_tools_serialize(
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/api/mcp_catalog/v1/mcp_servers/{server_id}/tools",
    ...
    def find_mcp_servers(
        self,
        name: Annotated[StrictStr | None, Field(description="Filter MCP servers by server name using SQL LIKE pattern matching.")] = None,
        q: Annotated[StrictStr | None, Field(description="Free-form keyword search across name, description, and provider.")] = None,
        source_label: Annotated[list[StrictStr] | None, Field(description="Filter MCP servers by the label associated with the source. Multiple values can be separated by commas. If one of the values is the string `null`, then MCP servers from every source without a label will be returned.")] = None,
        filter_query: Annotated[Annotated[str, Field(strict=True)] | None, Field(description='A SQL-like query string to filter MCP servers.  **Supported Operators:** - Comparison: `=`, `!=`, `<>`, `>`, `<`, `>=`, `<=` - Pattern matching: `LIKE`, `ILIKE` (case-insensitive) - Set membership: `IN` - Logical: `AND`, `OR` - Grouping: `()` for complex expressions  **Examples:** - `license = "Apache 2.0"` - `verifiedSource = true` - `provider ILIKE "%local%"` - `(license = "Apache 2.0" OR license = "MIT") AND verifiedSource = true` ')] = None,
        named_query: Annotated[StrictStr | None, Field(description="Predefined filter template name to apply when listing MCP servers.")] = None,
        include_tools: Annotated[StrictBool | None, Field(description="Whether to include the tools array in each MCP server result.")] = None,
        tool_limit: Annotated[Annotated[int, Field(le=100, strict=True, ge=0)] | None, Field(description="Maximum number of tools to include when includeTools is true.")] = None,
        page_size: Annotated[Annotated[str, Field(strict=True)] | None, Field(description="Number of entities in each page.")] = None,
        order_by: Annotated[OrderByField | None, Field(description="Specifies the order by criteria for listing entities.")] = None,
        sort_order: Annotated[SortOrder | None, Field(description="Specifies the sort order for listing entities, defaults to ASC.")] = None,
        next_page_token: Annotated[StrictStr | None, Field(description="Opaque pagination token returned by a previous list call. Do not construct manually; use the value from a prior response's nextPageToken field.")] = None,
    ...
    def _find_mcp_servers_serialize(
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/api/mcp_catalog/v1/mcp_servers",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _find_mcp_servers_filter_options_serialize(
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/api/mcp_catalog/v1/mcp_servers/filter_options",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_mcp_server_serialize(
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/api/mcp_catalog/v1/mcp_servers/{server_id}",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _get_mcp_server_tool_serialize(
        ...
        return self.api_client.param_serialize(
            method="GET",
            resource_path="/api/mcp_catalog/v1/mcp_servers/{server_id}/tools/{tool_name}",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
