...
// McpEndpoints Network endpoints for remote MCP servers. Contains URLs for different transport protocols. At least one endpoint must be provided for remote servers.
