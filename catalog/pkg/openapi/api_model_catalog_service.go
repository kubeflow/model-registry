...
*/
func (a *ModelCatalogServiceAPIService) FindMcpServerTools(ctx context.Context, serverId string) ApiFindMcpServerToolsRequest {
	return ApiFindMcpServerToolsRequest{
		ApiService: a,
		ctx:        ctx,
		serverId:   serverId,
...
//
//	@return McpToolsList
func (a *ModelCatalogServiceAPIService) FindMcpServerToolsExecute(r ApiFindMcpServerToolsRequest) (*McpToolsList, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ModelCatalogServiceAPIService.FindMcpServerTools")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *ModelCatalogServiceAPIService) FindMcpServers(ctx context.Context) ApiFindMcpServersRequest {
	return ApiFindMcpServersRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *ModelCatalogServiceAPIService) FindMcpServersExecute(r ApiFindMcpServersRequest) (*McpServerList, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ModelCatalogServiceAPIService.FindMcpServers")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *ModelCatalogServiceAPIService) FindMcpServersFilterOptions(ctx context.Context) ApiFindMcpServersFilterOptionsRequest {
	return ApiFindMcpServersFilterOptionsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *ModelCatalogServiceAPIService) FindMcpServersFilterOptionsExecute(r ApiFindMcpServersFilterOptionsRequest) (*FilterOptionsList, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ModelCatalogServiceAPIService.FindMcpServersFilterOptions")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *ModelCatalogServiceAPIService) GetMcpServer(ctx context.Context, serverId string) ApiGetMcpServerRequest {
	return ApiGetMcpServerRequest{
		ApiService: a,
		ctx:        ctx,
		serverId:   serverId,
...
//
//	@return McpServer
func (a *ModelCatalogServiceAPIService) GetMcpServerExecute(r ApiGetMcpServerRequest) (*McpServer, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ModelCatalogServiceAPIService.GetMcpServer")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiGetMcpServerToolRequest) Execute() (*McpTool, *http.Response, error) {
...
*/
func (a *ModelCatalogServiceAPIService) GetMcpServerTool(ctx context.Context, serverId string, toolName string) ApiGetMcpServerToolRequest {
	return ApiGetMcpServerToolRequest{
		ApiService: a,
		ctx:        ctx,
		serverId:   serverId,
...
//
//	@return McpTool
func (a *ModelCatalogServiceAPIService) GetMcpServerToolExecute(r ApiGetMcpServerToolRequest) (*McpTool, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *McpTool
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "ModelCatalogServiceAPIService.GetMcpServerTool")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
