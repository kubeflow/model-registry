...
// McpArtifact An artifact for an MCP server (e.g., OCI image for local deployment).
type McpArtifact struct {
	// URI where the artifact can be retrieved (e.g., OCI image URI).
	Uri string `json:"uri"`
	// Timestamp when the artifact was created (milliseconds since epoch).
	CreateTimeSinceEpoch *string `json:"createTimeSinceEpoch,omitempty"`
	// Timestamp when the artifact was last updated (milliseconds since epoch).
