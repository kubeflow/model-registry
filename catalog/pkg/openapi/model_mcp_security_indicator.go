...
// McpSecurityIndicator Security indicators for an MCP server.
type McpSecurityIndicator struct {
	// Whether the source has been verified.
	VerifiedSource *bool `json:"verifiedSource,omitempty"`
	// Whether the endpoint uses secure communication.
	SecureEndpoint *bool `json:"secureEndpoint,omitempty"`
	// Whether static application security testing has been performed.
	Sast *bool `json:"sast,omitempty"`
	// Whether all tools are read-only.
