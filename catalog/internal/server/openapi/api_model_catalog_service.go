...
func (c *ModelCatalogServiceAPIController) FindMcpServers(w http.ResponseWriter, r *http.Request) {
	query, err := parseQuery(r.URL.RawQuery)
	if err != nil {
		c.errorHandler(w, r, &ParsingError{Err: err}, nil)
		return
...
func (c *ModelCatalogServiceAPIController) FindMcpServersFilterOptions(w http.ResponseWriter, r *http.Request) {
...
func (c *ModelCatalogServiceAPIController) GetMcpServer(w http.ResponseWriter, r *http.Request) {
...
func (c *ModelCatalogServiceAPIController) FindMcpServerTools(w http.ResponseWriter, r *http.Request) {
	query, err := parseQuery(r.URL.RawQuery)
	if err != nil {
		c.errorHandler(w, r, &ParsingError{Err: err}, nil)
		return
...
func (c *ModelCatalogServiceAPIController) GetMcpServerTool(w http.ResponseWriter, r *http.Request) {
	serverIdParam := chi.URLParam(r, "server_id")
	if serverIdParam == "" {
		c.errorHandler(w, r, &RequiredError{"server_id"}, nil)
		return
