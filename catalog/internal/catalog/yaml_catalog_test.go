	...
	}{
		{
			...
			yamlModel: yamlModel{
				CatalogModel: model.CatalogModel{
					Name:                     "test-model",
					Description:              *model.NewNullableString(apiutils.Of("Test model description")),
					Readme:                   *model.NewNullableString(apiutils.Of("# Test Model\nThis is a test model.")),
					Maturity:                 *model.NewNullableString(apiutils.Of("Generally Available")),
					Language:                 []string{"en", "fr"},
					Tasks:                    []string{"text-generation", "nlp"},
					Provider:                 *model.NewNullableString(apiutils.Of("IBM")),
					Logo:                     *model.NewNullableString(apiutils.Of("https://example.com/logo.png")),
					License:                  *model.NewNullableString(apiutils.Of("apache-2.0")),
					LicenseLink:              *model.NewNullableString(apiutils.Of("https://www.apache.org/licenses/LICENSE-2.0")),
					LibraryName:              *model.NewNullableString(apiutils.Of("transformers")),
