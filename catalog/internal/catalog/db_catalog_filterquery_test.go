...
func TestArtifactFilteringEdgeCases(t *testing.T) {
	tests := []struct {
		...
		},
		{
			...
			description: "OR conditions on artifact properties should use EXISTS subqueries with properly qualified columns",
		},
		{
		...
		},
		{
			...
			description: "Complex OR with custom and artifact properties should properly qualify all columns",
		},
		{
		...
		},
		{
			...
			expectedSQL: []string{
				...
				`"Artifact"`,
				`"ArtifactProperty"`,
				`"ArtifactProperty".string_value LIKE $`,
				"OR",
			},
			description: "OR with artifact LIKE patterns should properly qualify columns",
		},
		{
