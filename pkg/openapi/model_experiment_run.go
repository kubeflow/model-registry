...
func (o *ExperimentRun) UnmarshalJSON(data []byte) (err error) {
	...
	varExperimentRun := _ExperimentRun{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varExperimentRun)

	if err != nil {
		return err
	}

	*o = ExperimentRun(varExperimentRun)
