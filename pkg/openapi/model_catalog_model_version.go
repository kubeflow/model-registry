...
// checks if the CatalogModelVersion type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CatalogModelVersion{}

// CatalogModelVersion Represents a CatalogModelVersion belonging to a CatalogModel.
type CatalogModelVersion struct {
...
// NewCatalogModelVersionWithDefaults instantiates a new CatalogModelVersion object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewCatalogModelVersionWithDefaults() *CatalogModelVersion {
	this := CatalogModelVersion{}
	var state ModelVersionState = MODELVERSIONSTATE_LIVE
	this.State = &state
	return &this
...
func (o *CatalogModelVersion) GetCustomProperties() map[string]MetadataValue {
...
func (o *CatalogModelVersion) GetCustomPropertiesOk() (*map[string]MetadataValue, bool) {
	if o == nil || IsNil(o.CustomProperties) {
		return nil, false
	}
...
func (o *CatalogModelVersion) HasCustomProperties() bool {
	if o != nil && !IsNil(o.CustomProperties) {
		return true
	}
...
func (o *CatalogModelVersion) SetCustomProperties(v map[string]MetadataValue) {
	o.CustomProperties = &v
}

// GetDescription returns the Description field value if set, zero value otherwise.
func (o *CatalogModelVersion) GetDescription() string {
...
// and a boolean to check if the value has been set.
func (o *CatalogModelVersion) GetDescriptionOk() (*string, bool) {
	if o == nil || IsNil(o.Description) {
		return nil, false
	}
...
func (o *CatalogModelVersion) HasDescription() bool {
	if o != nil && !IsNil(o.Description) {
		return true
	}
...
func (o *CatalogModelVersion) SetDescription(v string) {
	o.Description = &v
}

// GetExternalId returns the ExternalId field value if set, zero value otherwise.
func (o *CatalogModelVersion) GetExternalId() string {
...
// and a boolean to check if the value has been set.
func (o *CatalogModelVersion) GetExternalIdOk() (*string, bool) {
	if o == nil || IsNil(o.ExternalId) {
		return nil, false
	}
...
func (o *CatalogModelVersion) HasExternalId() bool {
	if o != nil && !IsNil(o.ExternalId) {
		return true
	}
...
func (o *CatalogModelVersion) SetExternalId(v string) {
	o.ExternalId = &v
}

// GetName returns the Name field value
func (o *CatalogModelVersion) GetName() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CatalogModelVersion) GetNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Name, true
...
func (o *CatalogModelVersion) SetName(v string) {
	o.Name = v
}

// GetState returns the State field value if set, zero value otherwise.
func (o *CatalogModelVersion) GetState() ModelVersionState {
...
// and a boolean to check if the value has been set.
func (o *CatalogModelVersion) GetStateOk() (*ModelVersionState, bool) {
	if o == nil || IsNil(o.State) {
		return nil, false
	}
	return o.State, true
...
func (o *CatalogModelVersion) HasState() bool {
	if o != nil && !IsNil(o.State) {
		return true
	}
...
func (o *CatalogModelVersion) SetState(v ModelVersionState) {
	o.State = &v
}

// GetAuthor returns the Author field value if set, zero value otherwise.
func (o *CatalogModelVersion) GetAuthor() string {
...
// and a boolean to check if the value has been set.
func (o *CatalogModelVersion) GetAuthorOk() (*string, bool) {
	if o == nil || IsNil(o.Author) {
		return nil, false
	}
...
func (o *CatalogModelVersion) HasAuthor() bool {
	if o != nil && !IsNil(o.Author) {
		return true
	}
...
func (o *CatalogModelVersion) SetAuthor(v string) {
	o.Author = &v
}
...
func (o CatalogModelVersion) ToMap() (map[string]interface{}, error) {
...
type NullableCatalogModelVersion struct {
	value *CatalogModelVersion
	isSet bool
}

func (v NullableCatalogModelVersion) Get() *CatalogModelVersion {
	return v.value
}

func (v *NullableCatalogModelVersion) Set(val *CatalogModelVersion) {
	v.value = val
	v.isSet = true
}

func (v NullableCatalogModelVersion) IsSet() bool {
	return v.isSet
}

func (v *NullableCatalogModelVersion) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCatalogModelVersion(val *CatalogModelVersion) *NullableCatalogModelVersion {
	return &NullableCatalogModelVersion{value: val, isSet: true}
}

func (v NullableCatalogModelVersion) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCatalogModelVersion) UnmarshalJSON(src []byte) error {
	v.isSet = true
