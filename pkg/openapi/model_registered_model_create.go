...
func (o *RegisteredModelCreate) UnmarshalJSON(data []byte) (err error) {
	...
	varRegisteredModelCreate := _RegisteredModelCreate{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varRegisteredModelCreate)

	if err != nil {
		return err
	}

	*o = RegisteredModelCreate(varRegisteredModelCreate)
