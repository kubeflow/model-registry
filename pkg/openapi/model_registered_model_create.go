...
func (o *RegisteredModelCreate) GetLongDescription() string {
...
// and a boolean to check if the value has been set.
func (o *RegisteredModelCreate) GetLongDescriptionOk() (*string, bool) {
	if o == nil || IsNil(o.LongDescription) {
		return nil, false
	}
...
func (o *RegisteredModelCreate) HasLongDescription() bool {
	if o != nil && !IsNil(o.LongDescription) {
		return true
	}
...
func (o *RegisteredModelCreate) SetLongDescription(v string) {
	o.LongDescription = &v
}
