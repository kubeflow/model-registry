...
// Comma-separated list of experiment run IDs to filter metric history by.
func (r ApiGetExperimentRunsMetricHistoryRequest) ExperimentRunIds(experimentRunIds string) ApiGetExperimentRunsMetricHistoryRequest {
	r.experimentRunIds = &experimentRunIds
	return r
}
...
Gets the metric history for multiple `ExperimentRun` entities with optional filtering by experiment run IDs, metric name, and step IDs.
...
func (a *ModelRegistryServiceAPIService) GetExperimentRunsMetricHistoryExecute(r ApiGetExperimentRunsMetricHistoryRequest) (*MetricList, *http.Response, error) {
	...
	if r.experimentRunIds != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "experimentRunIds", r.experimentRunIds, "")
	}
	if r.pageSize != nil {
		parameterAddToHeaderOrQuery(localVarQueryParams, "pageSize", r.pageSize, "")
	}
