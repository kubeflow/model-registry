...
type ModelVersionCreate struct {
	...
	// The client provided name of the context. It must be unique among all the contexts of the same type within a database instance and cannot be changed once set.
