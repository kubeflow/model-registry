...
func NewCatalogModelList(nextPageToken string, pageSize int32, size int32) *CatalogModelList {
...
func (o *CatalogModelList) HasItems() bool {
	if o != nil && !IsNil(o.Items) {
		return true
	}
...
// SetItems gets a reference to the given []CatalogModel and assigns it to the Items field.
