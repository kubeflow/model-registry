...
func (o *DocArtifactUpdate) GetName() string {
...
func (o *DocArtifactUpdate) GetNameOk() (*string, bool) {
	if o == nil || IsNil(o.Name) {
		return nil, false
	}
	return o.Name, true
...
func (o *DocArtifactUpdate) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *DocArtifactUpdate) SetName(v string) {
	o.Name = &v
}
