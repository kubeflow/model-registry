...
func (o *RegisteredModel) GetLongDescription() string {
...
// and a boolean to check if the value has been set.
func (o *RegisteredModel) GetLongDescriptionOk() (*string, bool) {
	if o == nil || IsNil(o.LongDescription) {
		return nil, false
	}
...
func (o *RegisteredModel) HasLongDescription() bool {
	if o != nil && !IsNil(o.LongDescription) {
		return true
	}
...
func (o *RegisteredModel) SetLongDescription(v string) {
	o.LongDescription = &v
}
