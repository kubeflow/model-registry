...
func (o *ModelArtifactUpdate) GetName() string {
...
func (o *ModelArtifactUpdate) GetNameOk() (*string, bool) {
	if o == nil || IsNil(o.Name) {
		return nil, false
	}
	return o.Name, true
...
func (o *ModelArtifactUpdate) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *ModelArtifactUpdate) SetName(v string) {
	o.Name = &v
}
