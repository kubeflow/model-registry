...
func (o *BaseResourceUpdate) GetName() string {
...
func (o *BaseResourceUpdate) GetNameOk() (*string, bool) {
	if o == nil || IsNil(o.Name) {
		return nil, false
	}
	return o.Name, true
...
func (o *BaseResourceUpdate) HasName() bool {
	if o != nil && !IsNil(o.Name) {
		return true
	}
...
func (o *BaseResourceUpdate) SetName(v string) {
	o.Name = &v
}
