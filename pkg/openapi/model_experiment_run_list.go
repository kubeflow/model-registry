...
func (o *ExperimentRunList) UnmarshalJSON(data []byte) (err error) {
	...
	varExperimentRunList := _ExperimentRunList{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varExperimentRunList)

	if err != nil {
		return err
	}

	*o = ExperimentRunList(varExperimentRunList)
