...
// types are available:
//
//	import _ "github.com/kubeflow/hub/internal/platform/db/drivers"
package drivers

import (
	_ "github.com/kubeflow/hub/internal/platform/db/mysql"
	_ "github.com/kubeflow/hub/internal/platform/db/postgres"
)
