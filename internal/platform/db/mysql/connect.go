...
import (
	...
	_tls "github.com/kubeflow/model-registry/internal/platform/tls"
...
func init() {
	platformdb.RegisterConnectorFactory(types.DatabaseTypeMySQL, func(dsn string, tlsConfig *_tls.TLSConfig) platformdb.Connector {
		return NewMySQLDBConnector(dsn, tlsConfig)
	})
}
