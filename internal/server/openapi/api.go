...
type ModelRegistryServiceAPIServicer interface {
	...
	GetArtifacts(context.Context, model.ArtifactTypeQueryParam, string, model.OrderByField, model.SortOrder, string) (ImplResponse, error)
	...
	GetExperimentExperimentRuns(context.Context, string, string, string, string, model.OrderByField, model.SortOrder, string) (ImplResponse, error)
	GetExperimentRun(context.Context, string) (ImplResponse, error)
	GetExperimentRunArtifacts(context.Context, string, string, string, model.ArtifactTypeQueryParam, string, model.OrderByField, model.SortOrder, string) (ImplResponse, error)
	GetExperimentRunMetricHistory(context.Context, string, string, string, string, model.OrderByField, model.SortOrder, string) (ImplResponse, error)
	GetExperimentRuns(context.Context, string, model.OrderByField, model.SortOrder, string) (ImplResponse, error)
	GetExperiments(context.Context, string, model.OrderByField, model.SortOrder, string) (ImplResponse, error)
	...
	GetModelVersionArtifacts(context.Context, string, string, string, model.ArtifactTypeQueryParam, string, model.OrderByField, model.SortOrder, string) (ImplResponse, error)
