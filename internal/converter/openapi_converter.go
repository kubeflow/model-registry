...
type OpenAPIConverter interface {
	...
	// goverter:ignore Id CreateTimeSinceEpoch LastUpdateTimeSinceEpoch Description ExternalId CustomProperties State Owner LongDescription Readme Maturity Language Tasks Provider Logo License LicenseLink LibraryName
