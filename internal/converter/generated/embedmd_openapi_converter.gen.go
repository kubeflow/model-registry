...
func (c *EmbedMDToOpenAPIConverterImpl) ConvertDataSet(source *models.BaseEntity[models.DataSetAttributes]) (*openapi.DataSet, error) {
	...
	if source != nil {
		...
		openapiDataSet.ExperimentId = converter.MapEmbedMDExperimentId((*source))
		openapiDataSet.ExperimentRunId = converter.MapEmbedMDExperimentRunId((*source))
...
func (c *EmbedMDToOpenAPIConverterImpl) ConvertDocArtifact(source *models.BaseEntity[models.DocArtifactAttributes]) (*openapi.DocArtifact, error) {
	...
	if source != nil {
		...
		openapiDocArtifact.ExperimentId = converter.MapEmbedMDExperimentId((*source))
		openapiDocArtifact.ExperimentRunId = converter.MapEmbedMDExperimentRunId((*source))
...
func (c *EmbedMDToOpenAPIConverterImpl) ConvertMetric(source *models.BaseEntity[models.MetricAttributes]) (*openapi.Metric, error) {
	...
	if source != nil {
		...
		openapiMetric.ExperimentId = converter.MapEmbedMDExperimentId((*source))
		openapiMetric.ExperimentRunId = converter.MapEmbedMDExperimentRunId((*source))
...
func (c *EmbedMDToOpenAPIConverterImpl) ConvertModelArtifact(source *models.BaseEntity[models.ModelArtifactAttributes]) (*openapi.ModelArtifact, error) {
	...
	if source != nil {
		...
		openapiModelArtifact.ExperimentId = converter.MapEmbedMDExperimentId((*source))
		openapiModelArtifact.ExperimentRunId = converter.MapEmbedMDExperimentRunId((*source))
...
func (c *EmbedMDToOpenAPIConverterImpl) ConvertParameter(source *models.BaseEntity[models.ParameterAttributes]) (*openapi.Parameter, error) {
	...
	if source != nil {
		...
		openapiParameter.ExperimentId = converter.MapEmbedMDExperimentId((*source))
		openapiParameter.ExperimentRunId = converter.MapEmbedMDExperimentRunId((*source))
