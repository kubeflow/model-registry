...
def _parser() -> cap.ArgumentParser:
    ...
    # --- destination ---
    # s3
    p.add("--destination-type", choices=["s3", "oci"], default="s3")
    ...
    p.add(
        ...
        metavar="PATH",
        help="Path to an AWS-style INI, JSON, or Docker config.json containing the *source* credentials (matches source-type).",
    )
    p.add(
        "--destination-s3-credentials-path",
        metavar="PATH",
        help="Path to an AWS-style INI, JSON, or Docker config.json containing the *destination* credentials (matches destination-type).",
    )
    p.add(
        "--source-oci-credentials-path",
        metavar="PATH",
        help="Path to an OCI credentials file containing the *source* credentials (matches source-type).",
    )
    p.add(
        "--destination-oci-credentials-path",
        metavar="PATH",
        help="Path to an OCI credentials file containing the *destination* credentials (matches destination-type).",
    )
