...
require (
	...
	github.com/kubeflow/model-registry v0.2.2-alpha
)
...
// Uncomment next line to use the local model-registry library
// replace github.com/kubeflow/model-registry v0.2.1-alpha => ../
